...
public class JBDC {
		...
		public static void main(String[] args) throws ClassNotFoundException, SQLException{
			...
			insertQuery="insert into test(id, name , desc, stock) values (2, 'Sugar','Grocery',30)";
			stmt.executeUpdate(insertQuery);
			insertQuery="insert into test(id, name , desc, stock) values (3, 'Milk','Dairy',25)";
			stmt.executeUpdate(insertQuery);*/
			...
			while(rs.next()) {
			 ...
			 stmt.executeQuery("update inventory set stock=50 where id=3 ");
